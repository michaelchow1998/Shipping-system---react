          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden bg-indigo-700 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 max-w-3xl text-base text-indigo-50">
                24 hours customer service support, we will follow your need as
                soon as possible. And thank you for your message.
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  <PhoneIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">+852 9143-4567</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  <MailIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">support@shipsheep.com</span>
                </dd>
              </dl>
            ...
            {sent && (
              <div className="px-6 pt-5 sm:px-10 lg:col-span-2 xl:p-12">
                <div className="flex flex-col items-center justify-center py-56">
                  <h3 className="text-4xl font-semibold">
                    Your message sent. Thank You.
                  </h3>
                  <div className="mt-6 sm:col-span-2 sm:flex sm:justify-end">
                    <button
                      type="submit"
                      onClick={backBtnHandler}
                      className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                    >
                      Back
                    </button>
                  </div>
